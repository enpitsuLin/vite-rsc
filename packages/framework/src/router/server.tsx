...
export interface MiddlewareContext {
  get: (<Key extends keyof ServerContext>(
    key: Key,
    truthy: true,
  ) => NonNullable<ServerContext[Key]>) & (<Key extends keyof ServerContext>(
    key: Key,
    truthy?: false,
  ) => undefined | ServerContext[Key]) & (<Key extends keyof ServerContext>(
    key: Key,
...
export interface RouteModule {
  default?: (props: any) => Awaited<React.ReactNode>
...
export const asyncLocalStorage = globalThis.__asyncLocalStorage
